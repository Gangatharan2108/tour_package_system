...
$pitinary=$_POST['packageitinary'];	
$pimage=$_FILES["packageimage"]["name"];
$sql="update TblTourPackages set PackageName=:pname,PackageType=:ptype,PackageLocation=:plocation,PackagePrice=:pprice,PackageDuration=:pduration,PackageFetures=:pfeatures,PackageDetails=:pdetails,PackageItinary=:pitinary where PackageId=:pid";
...
$query->bindParam(':pitinary',$pitinary,PDO::PARAM_STR);
...
<!--heder end here-->
	<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="dashboard.php" style="background-color:skyblue;color:black;">Home</a><i class="fa fa-angle-right"></i>Update Tour Package </li>
            </ol>
		<!--grid-->
 	<div class="grid-form">
...
<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Package Duration</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="packageduration" id="packageduration" placeholder=" Package Duration" value="<?php echo htmlentities($result->PackageDuration);?>" required>
									</div>
								</div>
<div class="form-group">
...
<div class="form-group">
									...
									<div class="col-sm-8">
										<textarea class="form-control" rows="5" cols="50" name="packageitinary" id="packageitinary" placeholder="Package Itinerary" required><?php echo htmlentities($result->PackageItinary);?></textarea> 
									</div>
								</div>															
<div class="form-group">

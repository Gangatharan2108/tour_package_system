...
<!--heder end here-->
<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="dashboard.php" style="background-color:skyblue;color:black;">Home</a><i class="fa fa-angle-right"></i>Manage Packages</li>
            </ol>
...
{				?>		
						  <tr>
							...
							<td>INR <?php echo htmlentities($result->PackagePrice);?></td>

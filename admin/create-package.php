...
$sql="INSERT INTO tbltourpackages(PackageName,PackageType,PackageLocation,PackagePrice,PackageDuration,PackageFetures,PackageDetails,PackageItinary,PackageImage) VALUES(:pname,:ptype,:plocation,:pprice,:pduration,:pfeatures,:pdetails,:pitinary,:pimage)";
...
<!--heder end here-->
	<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="dashboard.php" style="background-color:skyblue;color:black;">Home</a><i class="fa fa-angle-right"></i>Create Package </li>
            </ol>
		<!--grid-->
 	<div class="grid-form">
...
<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="packageduration" id="packageduration" placeholder=" Package Duration" required>
									</div>
								</div>
...
<div class="form-group">
									...
									<div class="col-sm-8">
										<textarea class="form-control" rows="5" cols="50" name="packageitinary" id="packageitinary" placeholder="Package Itinerary" required></textarea> 
									</div>
								</div>														
<div class="form-group">
